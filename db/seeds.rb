...
Feedback.create({ user_id: user1.id, comment: "tres satisfait", commantator_id: user4.id, rating: 5 })
Feedback.create({ user_id: user3.id, comment: "moyenement satisfait", commantator_id: user4.id, rating: 3 })
